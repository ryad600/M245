<?php
		 ...
		 */
		function create_new_spot_res($sku, $active, $id_category, $name, $image, $description, $price, $stock) {
			global $database;
		 ...
		 */
		function update_spot_res($product_id, $sku, $active, $id_category, $name, $image, $description, $price, $stock) {
			global $database;
		 ...
		 */
		function get_one_spot_res($product_id) {
			global $database;
		 ...
		 */
		function delete_spot_res($product_id) {
			global $database;
